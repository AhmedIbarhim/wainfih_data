...
mixin _$AgentProviderModel {
 ...
 String? get serviceProviderNameAr; String? get serviceProviderNameEn; String get mobileNumber1; String? get mobileNumber2; String? get contactPersonName; String? get notes; Map<String, dynamic> get image; double get lat; double get lng; int? get districtId; List<int>? get categoryIds;
...
@useResult
$Res call({
 String? serviceProviderNameAr, String? serviceProviderNameEn, String mobileNumber1, String? mobileNumber2, String? contactPersonName, String? notes, Map<String, dynamic> image, double lat, double lng, int? districtId, List<int>? categoryIds
});
...
/// Create a copy of AgentProviderModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? serviceProviderNameAr = freezed,Object? serviceProviderNameEn = freezed,Object? mobileNumber1 = null,Object? mobileNumber2 = freezed,Object? contactPersonName = freezed,Object? notes = freezed,Object? image = null,Object? lat = null,Object? lng = null,Object? districtId = freezed,Object? categoryIds = freezed,}) {
...
switch (_that) {
case _AgentProviderModel() when $default != null:
return $default(_that.serviceProviderNameAr,_that.serviceProviderNameEn,_that.mobileNumber1,_that.mobileNumber2,_that.contactPersonName,_that.notes,_that.image,_that.lat,_that.lng,_that.districtId,_that.categoryIds);case _:
  return orElse();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _AgentProviderModel&&(identical(other.serviceProviderNameAr, serviceProviderNameAr) || other.serviceProviderNameAr == serviceProviderNameAr)&&(identical(other.serviceProviderNameEn, serviceProviderNameEn) || other.serviceProviderNameEn == serviceProviderNameEn)&&(identical(other.mobileNumber1, mobileNumber1) || other.mobileNumber1 == mobileNumber1)&&(identical(other.mobileNumber2, mobileNumber2) || other.mobileNumber2 == mobileNumber2)&&(identical(other.contactPersonName, contactPersonName) || other.contactPersonName == contactPersonName)&&(identical(other.notes, notes) || other.notes == notes)&&const DeepCollectionEquality().equals(other._image, _image)&&(identical(other.lat, lat) || other.lat == lat)&&(identical(other.lng, lng) || other.lng == lng)&&(identical(other.districtId, districtId) || other.districtId == districtId)&&const DeepCollectionEquality().equals(other._categoryIds, _categoryIds));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,serviceProviderNameAr,serviceProviderNameEn,mobileNumber1,mobileNumber2,contactPersonName,notes,const DeepCollectionEquality().hash(_image),lat,lng,districtId,const DeepCollectionEquality().hash(_categoryIds));
...
/// Create a copy of AgentProviderModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? serviceProviderNameAr = freezed,Object? serviceProviderNameEn = freezed,Object? mobileNumber1 = null,Object? mobileNumber2 = freezed,Object? contactPersonName = freezed,Object? notes = freezed,Object? image = null,Object? lat = null,Object? lng = null,Object? districtId = freezed,Object? categoryIds = freezed,}) {
