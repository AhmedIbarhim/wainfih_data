...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    "addProviderAction": MessageLookupByLibrary.simpleMessage(
      "إضافة مقدم خدمة",
    ),
    "addProviderTitle": MessageLookupByLibrary.simpleMessage(
    ...
    "contactPerson": MessageLookupByLibrary.simpleMessage("اسم الشخص المسؤول"),
    ...
    "deleteAccountRequestSent": MessageLookupByLibrary.simpleMessage(
      "تم إرسال طلب حذف الحساب",
    ),
    "descriptionLabel": MessageLookupByLibrary.simpleMessage("وصف الخدمة"),
    "districtLabel": MessageLookupByLibrary.simpleMessage("الحي"),
    "editButton": MessageLookupByLibrary.simpleMessage("تعديل"),
    "emailLabel": MessageLookupByLibrary.simpleMessage("البريد الإلكتروني"),
    "emailNotVerifiedError": MessageLookupByLibrary.simpleMessage(
    ...
    "filterPending": MessageLookupByLibrary.simpleMessage("قيد الانتظار"),
    "filterThisMonth": MessageLookupByLibrary.simpleMessage("هذا الشهر"),
    "filterThisWeek": MessageLookupByLibrary.simpleMessage("هذا الأسبوع"),
    "filterToday": MessageLookupByLibrary.simpleMessage("اليوم"),
    "getCurrentLocation": MessageLookupByLibrary.simpleMessage(
      "تحديد موقعي الحالي",
    ),
    "homeWelcomeSubtitle": MessageLookupByLibrary.simpleMessage(
    ...
    "mobileLabel": MessageLookupByLibrary.simpleMessage("رقم الجوال"),
    "mobileNumber": MessageLookupByLibrary.simpleMessage("رقم الجوال"),
    "myProvidersTitle": MessageLookupByLibrary.simpleMessage(
      "مقدمي الخدمة الخاصة بي",
    ),
    ...
    "providerNameAr": MessageLookupByLibrary.simpleMessage(
      "اسم مقدم الخدمة بالعربية",
    ),
    "providerNameEn": MessageLookupByLibrary.simpleMessage(
      "اسم مقدم الخدمة بالإنجليزية",
    ),
    "queueCompleted": MessageLookupByLibrary.simpleMessage("تم الإرسال بنجاح"),
    "queueEmpty": MessageLookupByLibrary.simpleMessage(
      "لا توجد عناصر في قائمة الانتظار",
    ),
    "queueFailed": MessageLookupByLibrary.simpleMessage("فشل الإرسال"),
    "queueStatusPending": MessageLookupByLibrary.simpleMessage("في الانتظار"),
    "queueSubmitting": MessageLookupByLibrary.simpleMessage("جارٍ الإرسال..."),
    "queueTitle": MessageLookupByLibrary.simpleMessage("قائمة الانتظار"),
    "queueUploadingImage": MessageLookupByLibrary.simpleMessage(
      "جارٍ رفع الصورة...",
    ),
    ...
    "roleRejectionError": MessageLookupByLibrary.simpleMessage(
      "ليس لديك صلاحية الوصول لهذا التطبيق",
    ),
    "save": MessageLookupByLibrary.simpleMessage("حفظ"),
    "saveButton": MessageLookupByLibrary.simpleMessage("حفظ"),
    "secondMobile": MessageLookupByLibrary.simpleMessage("رقم الجوال الثاني"),
    "selectCityFirst": MessageLookupByLibrary.simpleMessage(
      "اختر المدينة أولاً",
    ),
    ...
    "stepPhotoAndLocation": MessageLookupByLibrary.simpleMessage(
      "الصورة والموقع",
    ),
    ...
    "validationImageRequired": MessageLookupByLibrary.simpleMessage(
      "يجب إضافة صورة واحدة على الأقل",
    ),
    "validationLocationRequired": MessageLookupByLibrary.simpleMessage(
      "يجب تحديد الموقع على الخريطة",
    ),
    "validationMobileRequired": MessageLookupByLibrary.simpleMessage(
      "رقم الجوال مطلوب",
    ),
    "validationTypeRequired": MessageLookupByLibrary.simpleMessage(
      "نوع الخدمة مطلوب",
    ),
    "verificationSubtitle": MessageLookupByLibrary.simpleMessage(
      "أدخل رمز التحقق المرسل إلى جوالك",
    ),
    "verificationTitle": MessageLookupByLibrary.simpleMessage("تفعيل الحساب"),
    "viewProvidersAction": MessageLookupByLibrary.simpleMessage(
      "عرض مقدمي الخدمة",
    ),
  };
}
